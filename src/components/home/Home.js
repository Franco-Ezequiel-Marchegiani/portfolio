  ...
  return (
    <div className="body">
      ...
      <p className='myNameHome'>Franco Ezequiel Marchegiani</p>
          <h1 className="titleHome">Full stack <span className='spanTitleHome'>Developer</span></h1>
          <hr className='lineHome' />
          <p className="parrafoHome">Soy Tutor de Front-End & Programador de Full stack durante mas de un año. Estas mismas son mis pasiones, ya que me encanta el programar, el crear sitios web y me gusta el enseñar lo que aprendí. En ambientes de trabajo me destaco por ser constante, detallista, concentrarme en las tareas que debo realizar, y sobre todo el trabajar en equipo, ya que considero de que los grandes proyectos se logran trabajando en equipo.</p>
          <p className="parrafoHome segundoParrafoHome">Mis motivaciones son las de superar desafios diarios y el brindarles productos de valor a terceros, actualmente vivo en Argentina (CABA), tengo 23 años y me encantaria el poder dedicarme al 100% en el mundo de la programacion, el encontrarme con nuevos y mas grandes desafios y el poder convivir y trabajar con gente con mi misma pasion</p>
